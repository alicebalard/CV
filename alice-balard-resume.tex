...
\Large{ \faIcon{award}} & \textcolor{teal}{\textbf{AWARDS \& FUNDINGS}} \\\vspace{-6pt}
     ...
     & Molecular trade-offs between adaptation to salinity and immunity in three-spined sticklebacks \\\vspace{-6pt} 
     & \\
     & \textbf{£200 student travel grant for the BSP Spring Meeting (2019)}\\
...
\Large{\faIcon{users}} & \textcolor{teal}{\textbf{TEACHING EXPERIENCE}} \\\vspace{-6pt}     
     & \\
     & \textbf{Teaching during postdoc in UCL, UK (2025)}\\
     & \parbox{7.0in}{BIOL0003 Introduction to Genetics (1h)} \\\vspace{-6pt} 
     & \parbox{7.0in}{BIOL0058 Core skills Y3 (1h)} \\\vspace{-6pt}  & \\
     & \parbox{7.0in}{GENE0006 Understanding Bioinformatics Resources and Their Application Level 7 (1h)} \\\vspace{-6pt} 
     & \\
     & \textbf{Teaching fellow, QMUL, UK (2023 - 2024)}\\
     & \parbox{7.0in}{Delivered lectures on statistics, bioinformatics and fundamental biology in several modules across levels 4 to 7 ("Diversity and Ecology", "Practical molecular and cellular biology", "Research method and communication", "Coding and data science", etc.). 
     Module organiser and delivery of Missing Biological Data Team Challenge in "AI in the Biosciences" level 7} \\\vspace{-6pt} 
     & \\
     & \textbf{R for complete beginners workshop, QMUL, UK (2021 - 2023)}\\
     & \parbox{7.0in}{14 hours of gained teaching experience. PhD students, postdocs, and other research staff} \\\vspace{-6pt} 
     & \\
     & \textbf{Attend “Train the trainer” programme, QMUL, UK  (2021)}\\
     & \parbox{7.0in}{Postdocs training to design and deliver courses to doctoral students} \\\vspace{-6pt} 
     & \\
