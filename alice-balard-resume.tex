...
\usepackage{fontspec}
\setmainfont{TeX Gyre Termes} % or Heros, Pagella, Schola, Adventor …
...
\usepackage{graphicx}
\usepackage{geometry}
\pagenumbering{gobble} %Changes the page numbers - {arabic}=arabic numerals, {gobble}=no page numbers, {roman}=Roman numerals
...
%\usepackage{setspace}
%\usepackage{hyperref} %THERE
%\usepackage{fontawesome5} %for cool icons
% \usepackage{multicol} % THERE
...
%\usepackage{graphicx}
%\graphicspath{ {images/}} % if many images needed, in this folder. So far just one in main.
\usepackage[left=.5in, right=.5in, bottom=.1in, top=.4in]{geometry} % change the margins

%\pagenumbering{gobble} THERE
